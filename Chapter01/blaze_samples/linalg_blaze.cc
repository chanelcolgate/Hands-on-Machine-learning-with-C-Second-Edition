...
int main() {
	...
	// patial access
	{
		...
		// std::cout << "Modifiled middle of 4x4 matrix:\n" << m << std::endl;

		blaze::row<1UL>(m) += 3;
		// std::cout << "Modifiled row of 4x4 matrix:\n" << m << std::endl;

		blaze::column<2UL>(m) /= 4;
		// std::cout << "Modifiled col of 4x4 matrix:\n" << m << std::endl;
	}

	// broadcasting (There is no implicit broadcasting in Blaze)
	{
		// blaze::DynamicMatrix<float, blaze::rowVector> mat = {{2, 2, 2, 2},
		// 																										 {2, 2, 2, 2},
		// 																										 {2, 2, 2, 2},
		// 																										 {2, 2, 2, 2}};
