...
int main(int argc, char** argv) {
	if (argc > 1) {
		...
		MultivariateGaussianDist(dataset_multi.first, dataset_multi.second, "mlpack-multi-var.png");
		KernelDensityEstimation(dataset_multi.first, dataset_multi.second, "mlpack-kde.png");
		DensityEstimationTree(dataset_multi.first, dataset_multi.second, "mlpack-det.png");
	} else {
